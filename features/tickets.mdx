...
description: "Report incidents against dispensers or locations, assign technicians, track SLA compliance, and receive push and email notifications on status changes."
---
