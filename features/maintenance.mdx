...
description: "HDB Service auto-generates monthly maintenance schedules for every in-service dispenser, collects digital checklists, and captures cryptographically-signed customer approvals."
---
...
<Tip>
  Health score is a composite metric that weighs MTBF (40%), MTTR (20%), recurrence rate (20%), inspected condition rating (10%), and theoretical lifecycle progress (10%).
</Tip>
